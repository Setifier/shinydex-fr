...
export const SocialAuthButtons = () => {
  ...
  const [isPendingDiscord, setIsPendingDiscord] = useState(false);
  ...
  return (
    <div className="space-y-4 w-80">
      <Button
        ...
        disabled={isPendingGoogle || isPendingDiscord}
      >
        ...
        <span>
          {isPendingGoogle ? "Connexion..." : "Se connecter avec Google"}
        </span>
      </Button>
      ...
      >
        ...
        <span>
          {isPendingDiscord ? "Connexion..." : "Se connecter avec Discord"}
        </span>
      </Button>
    </div>
  );
